...
import '../CreateTodoPopUp/CreateTodoPopUp.css';
...
class EditTodoPopup extends Component {
    ...
    handleSubmit(e) {
        ...
        reqObj.modifiedBy = "prashant"
        delete reqObj['alert'];
        delete reqObj['message'];
        TodoService.updateTodo(reqObj).then(
            res => {
                if(res.status === 200){
                    this.setState({alert: true, message: 'Todo Updated Successfully!'});
                    setTimeout(() => { 
    ...
    render() {
        ...
        return(
            <div className="popup-box">
                <div className="box">
                    <h1 className="create-todo">Edit Todo</h1>
                    ...
                    <table className="create-table">
                            ...
                            <tr>
                                <td></td>
                                <td><center><input id="submit-btn" type="submit" value="Update Todo" /></center></td>
                            </tr>
                            <tr>
                                <td></td>
